...
public class MainMenuWindow : MonoBehaviour {
    ...
    private void Awake() {
        ...
        transform.Find("gameModeSub").GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        transform.Find("mainSub").GetComponent<RectTransform>().anchoredPosition = Vector2.zero;

        transform.Find("mainSub").Find("gameModeBtn").GetComponent<Button_UI>().ClickFunc = () => ShowSub(Sub.GameMode);
        transform.Find("mainSub").Find("gameModeBtn").GetComponent<Button_UI>().AddButtonSounds();
        ...
        transform.Find("gameModeSub").Find("backBtn").GetComponent<Button_UI>().ClickFunc = () => ShowSub(Sub.Main);
        transform.Find("gameModeSub").Find("backBtn").GetComponent<Button_UI>().AddButtonSounds();

        //transform.Find("gameModeSub").Find("playReactionBtn").GetComponent<Button_UI>().ClickFunc = () => Loader.Load(Loader.Scene.Reaction_mode);
        //transform.Find("gameModeSub").Find("playReactionBtn").GetComponent<Button_UI>().AddButtonSounds();

        //transform.Find("gameModeSub").Find("playNormalBtn").GetComponent<Button_UI>().ClickFunc = () => Loader.Load(Loader.Scene.GameScene);
        ...
        transform.Find("mainSub").Find("playReactionBtn").GetComponent<Button_UI>().ClickFunc = () => Loader.Load(Loader.Scene.Reaction_mode);
        transform.Find("mainSub").Find("playReactionBtn").GetComponent<Button_UI>().AddButtonSounds();
    ...
    private void ShowSub(Sub sub) {
        ...
        transform.Find("gameModeSub").gameObject.SetActive(false);
        ...
        case Sub.HowToPlay:
            ...
            break;
        case Sub.GameMode:
            transform.Find("gameModeSub").gameObject.SetActive(true);
            break;
        }
    }
